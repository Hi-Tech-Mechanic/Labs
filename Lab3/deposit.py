class TimeDeposit:
    ...
    def __str__(self):
        ...
        "{4:20}{5}\n{6:20}{7}\n{8:20}{9}\n".format(
            ...
            "Срок (мес.):", [self._period_limit[0], self._period_limit[1]],
            "Сумма:", [self._sum_limit[0], self._sum_limit[1]]))

        #return (f"Наименование:\t{self.name}\n"
        #        f"Валюта:\t{self.currency}\n"
        #        f"Процентная ставка:\t{self._interest_rate}"
        #        f"Срок (мес.):\t{self._period_limit[0], self._period_limit[1]}\n"
        #        f"Валюта:\t{self._sum_limit[0], self._sum_limit[1]}\n")
...
class BonusTimeDeposit(TimeDeposit):
    ...
    def _check_self(self):
        ...
        """
        super()._check_self()
        #assert 0 < self._bonus[0] <= 5 and self._bonus[1] >= 2000, \
...
deposits = (
    ...
    TimeDeposit("Мега проценты", interest_rate=95,
                     period_limit=(6, 18),
                     sum_limit=(1000, 100000))
)